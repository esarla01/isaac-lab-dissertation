...
from .isaac_lab_dissertation_marl_env_cfg import IsaacLabDissertationMarlEnvCfg


class IsaacLabDissertationMarlEnv(DirectMARLEnv):
    cfg: IsaacLabDissertationMarlEnvCfg

    def __init__(self, cfg: IsaacLabDissertationMarlEnvCfg, render_mode: str | None = None, **kwargs):
